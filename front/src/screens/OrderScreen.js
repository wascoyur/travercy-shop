...
import { ORDER_DELIVER_RESET, ORDER_PAY_RESET } from '../constants/orderConstatnts';
        ...
        <Col md={8}>
          <ListGroup variant='flush'>
            <ListGroup.Item>
              ...
              <p>
                <strong>почта электронная: </strong>{' '}
              ...
              {order.isDelivered ? (
                <Message variant='success'>
                  Дата доставки {order.deliveredAt}
                </Message>
              ) : (
